...
"""Assigns concepts to natural language text documents according to a prebuilt
or user-defined model.
"""

import six

from ..core import post, request_link, uri_as_str, _build_is_available_func
...
def assign_concepts(documents,
    ...
    return post(_SERVICE_ROOT + '/jobs', json=data, headers=headers)
