...
from ._services.compute import Compute as compute
...
from ._services.job_definitions import JobDefinitions as job_definitions
from ._services.job_execution import JobExecution as job_execution
