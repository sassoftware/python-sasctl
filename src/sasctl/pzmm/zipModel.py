...
class ZipModel:
    ...
    def zipFiles(fileDir, modelPrefix):
        ...
        modelPrefix : string
            Variable name for the model to be displayed in SAS Model Manager
            (i.e. hmeqClassTree + [Score.py || .pickle]).

        Yields
        ------
        BytesIO
            Byte stream representation of the ZIP file for importing into SAS Model Manager. In this form,
            the ZIP file can be imported into SAS Model Manager.
