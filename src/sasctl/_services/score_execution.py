...
def score_execution(cls, score_definition_id: str,  description: str = "", output_server_name: str = "cas-shared-default", output_library_name: str = "Public", output_table_name: str = ""):
    ...
    try:
        score_execution = sd.get(f"/scoreExecution/executions?filter=eq(scoreExecutionRequest.scoreDefinitionId,%27{score_definition_id}%27)") # how to use crud functions on something with such a specifc filter
