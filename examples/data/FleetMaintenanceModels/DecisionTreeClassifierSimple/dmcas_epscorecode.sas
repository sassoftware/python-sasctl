...
method run();
    set SASEP.IN;
    score(Accel, Accel_Ssor_Total, Ambient, CO2, CO2_emission, CO_emission, Coolant_Temp, Emission_alert, Engine_Load, Engine_Oil_Temp, Engine_RPM, Engine_control, Flow_Rate, Fog_control, Fuel_level, GPS_Altitude, GPS_Bearing, GPS_Latitude, GPS_Longitude, HC_emission, Intake_Air, Intake_Pressure, Litres_Per_km, NOx_emission, Oil_life, PM_emission, Speed_GPS, Speed_OBD, Speed_sensor, Throttle_Pos, Trip_Distance, Trip_Time, Turbo_Boost, Turbo_alert, Vibration, VibrationAlert_Total, Vibration_Recent, Vibration_alert, Voltage);
end;
enddata;
